...
RegisterNetEvent('qb-items:client:use:politiekleding-brigadier')
AddEventHandler('qb-items:client:use:politiekleding-brigadier', function()
    ...
    QBCore.Functions.Progressbar("politiekleding", "Werkkleding Aantrekken", 2000, false, true, {
		...
		-- RANG
		SetPedComponentVariation(PlayerPedId(), 11, 74, 4, 0)
		clothingitem = true
		end)
