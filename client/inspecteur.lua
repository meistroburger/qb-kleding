...
RegisterNetEvent('qb-items:client:use:politiekleding-inspecteur')
AddEventHandler('qb-items:client:use:politiekleding-inspecteur', function()
    ...
    QBCore.Functions.Progressbar("politiekleding", "Werkkleding Aantrekken", 2000, false, true, {
		...
		-- RANG
		SetPedComponentVariation(PlayerPedId(), 11, 74, 5, 0)
		clothingitem = true
		end)
