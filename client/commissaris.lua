...
RegisterNetEvent('qb-items:client:use:politiekleding-commissaris')
AddEventHandler('qb-items:client:use:politiekleding-commissaris', function()
    ...
    QBCore.Functions.Progressbar("politiekleding", "Werkkleding Aantrekken", 2000, false, true, {
		...
		-- RANG
		SetPedComponentVariation(PlayerPedId(), 11, 74, 7, 0)
		clothingitem = true
		end)
