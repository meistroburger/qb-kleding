...
RegisterNetEvent('qb-items:client:use:politiekleding-hoofdinspecteur')
AddEventHandler('qb-items:client:use:politiekleding-hoofdinspecteur', function()
    ...
    QBCore.Functions.Progressbar("politiekleding", "Werkkleding Aantrekken", 2000, false, true, {
		...
		-- RANG
		SetPedComponentVariation(PlayerPedId(), 11, 74, 6, 0)
		clothingitem = true
		end)
