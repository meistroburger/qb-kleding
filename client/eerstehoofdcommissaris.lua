...
RegisterNetEvent('qb-items:client:use:politiekleding-eerstehoofdcommissaris')
AddEventHandler('qb-items:client:use:politiekleding-eerstehoofdcommissaris', function()
    ...
    QBCore.Functions.Progressbar("politiekleding", "Werkkleding Aantrekken", 2000, false, true, {
		...
		-- RANG
		SetPedComponentVariation(PlayerPedId(), 11, 74, 9, 0)
		clothingitem = true
		end)
