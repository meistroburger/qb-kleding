...
RegisterNetEvent('qb-items:client:use:politiekleding-hoofdagent')
AddEventHandler('qb-items:client:use:politiekleding-hoofdagent', function()
    ...
    QBCore.Functions.Progressbar("politiekleding", "Werkkleding Aantrekken", 2000, false, true, {
		...
		-- RANG
		SetPedComponentVariation(PlayerPedId(), 11, 74, 3, 0)
		clothingitem = true
		end)
