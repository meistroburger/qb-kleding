...
RegisterNetEvent('qb-items:client:use:specialeoutfit1')
AddEventHandler('qb-items:client:use:specialeoutfit1', function()
	local player = PlayerPedId()
	if not clothingitem then
    QBCore.Functions.Progressbar("specialeoutfit1", "Bezig met Aantrekken...", 2000, false, true, {
		...
		-- RANG
		SetPedComponentVariation(PlayerPedId(), 11, 74, 2, 0)
		clothingitem = true
		end)
